...
const App = () => {
  ...
  const [mandysThings, setMandysThings] = useState([
    {
      name: 'cats',
      image:
    ...
    },
    {
      ...
      attributes: [
        ...
        'fun',
        'animal',
        "(Mandy doesn't acually own a giraffe)",
      ],
    },
    {
      name: 'Taffy',
  ...
  const [jaeyoungThings, setjaeyoungThings] = useState([
    {
      name: "energy drinks",
      image: "https://imgs.xkcd.com/comics/functional.png",  
      attributes: ["cracked", "reusability", "not a taco", "beautiful"],
    },
  ])
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<StyledThings things={mandysThings} />}
      />
      <Route
        path="/the-silly-things"
        element={<SillyThings things={jaeyoungThings} />}
      />
    </Routes>
  )
}
